/**
 * List of text displayed in notifications
 * @type {{
 * login_inProgress: string,
 * login_success: string,
 * login_fail: string,
 * logout_success: string,
 * create_inProgress: string,
 * create_success: string,
 * create_fail: string,
 * fetch_inProgress: string,
 * fetch_success: string,
 * fetch_fail: string,
 * send_inProgress: string,
 * send_success: string,
 * send_fail: string,
 * delete_inProgress: string,
